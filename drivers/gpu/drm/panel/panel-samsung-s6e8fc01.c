 ...
 * Copyright (C) 2021 0xF king@die.lu
 *
...
// 刷新率 改这里
static const unsigned int screen_refresh_rate = 60U;
...
//"C"
// #endif
unsigned int fuckXiaomiAduiRestrict();
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	/* ESD Err Fg Setting */
	lcm_dcs_write_seq_static(ctx, 0xED, 0x01, 0xCC, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x01);
	/* CRC SRGB/P3 Setting */
	...
	lcm_dcs_write_seq_static(ctx, 0x51, 0x01, 0x40);
	msleep(60);
...
static int lcm_get_modes(struct drm_panel *panel)
{
	...
	pr_info("Fuck restrict by 0xF returned %u.\n",fuckXiaomiAduiRestrict());
	//pr_info("%s-\n", __func__);
	return 1;
}
